...
$('#content').html(marked($('#content').text())).removeClass('rendering');
...
$('#inputsearch').on('input', function(e) {
    $('#content').unmark().mark($('#inputsearch').val(), { separateWordSearch: true, accuracy: "exactly",
    acrossElements: true, done: function() { 
